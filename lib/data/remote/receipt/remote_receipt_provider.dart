...
class RemoteReceiptProvider {
  ...
  Future<List<ReceiptModel>> getOprIncomingReceipts(
    ...
    int? page,
      ...
      _executeReceiptRequest<List<ReceiptModel>>(
        () async {
          ...
          return data
              .map(
                (json) => ReceiptModel.fromJson(json as Map<String, dynamic>),
              )
              .toList();
        },
  ...
  Future<ReceiptDetailModel> getDetailprOutgoingReceipts(
    ...
    String id,
      ...
      _executeReceiptRequest<ReceiptDetailModel>(
        () async {
          int timestamp = DateTime.now().millisecondsSinceEpoch;
          Map<String, String> headers = {
            'Cookie': 'siklonsession=$cookie',
          ...
          if (_isSuccessResponse(response)) {
            ...
            return ReceiptDetailModel.fromJson(row as Map<String, dynamic>);
          } else {
