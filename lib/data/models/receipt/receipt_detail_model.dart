...
class ReceiptDetailModel extends ReceiptDetailEntity {
  ReceiptDetailModel({
    ...
    super.shipperPhone,
    super.contents,
    super.termsOfPayment,
    super.notifyPartyAddress,
    super.notifyPartyName,
    super.notifyPartyPhone,
  });
  ...
  factory ReceiptDetailModel.fromJson(Map<String, dynamic> json) =>
      ReceiptDetailModel(
        ...
        month: json['oprincomingreceipt_month'] as String? ?? '',
        ...
        contents: json['oprincomingreceipt_contents'] as String?,
        termsOfPayment: json['oprincomingreceipt_termsofpayment'] as String?,
        notifyPartyAddress:
            json['oprincomingreceipt_notifypartyaddress'] as String?,
        notifyPartyName: json['oprincomingreceipt_notifypartyname'] as String?,
        notifyPartyPhone:
            json['oprincomingreceipt_notifypartyphone'] as String?,
      );
}
