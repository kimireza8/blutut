...
class DetailShipmentModel extends DetailShipmentEntity {
  DetailShipmentModel({
    required super.id,
  ...
  factory DetailShipmentModel.fromJson(Map<String, dynamic> json) {
    return DetailShipmentModel(
      ...
      consigneeAddress: json['oprincomingreceipt_consigneeaddress'] as String? ?? '',
      consigneeCity: json['oprincomingreceipt_consigneecity'] as String? ?? '',
      consigneeName: json['oprincomingreceipt_consigneename'] as String? ?? '',
      consigneePhone: json['oprincomingreceipt_consigneephone'] as String? ?? '',
      ...
      customerRole: json['oprincomingreceipt_oprcustomerrole'] as String? ?? '',
      status: json['oprincomingreceipt_oprincomingreceiptstatus'] as String? ?? '',
      serviceType: json['oprincomingreceipt_oprkindofservice'] as String? ?? '',
      ...
      paymentLocation: json['oprincomingreceipt_paymentlocation'] as String? ?? '',
      receiptNumber: json['oprincomingreceipt_receiptnumber'] as String? ?? '',
      shipperAddress: json['oprincomingreceipt_shipperaddress'] as String? ?? '',
